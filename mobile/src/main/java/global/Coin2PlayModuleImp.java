...
import global.coin2play.DefaultCoinSelector;
...
public class Coin2PlayModuleImp implements Coin2PlayModule {

    private static final Logger logger = LoggerFactory.getLogger(Coin2PlayModuleImp.class);
    ...
    public Coin2PlayModuleImp(ContextWrapper contextWrapper, WalletConfiguration walletConfiguration,ContactsStoreDao contactsStore,RateDbDao rateDb,BackupHelper backupHelper) {
...
//    }
    ...
    public Transaction completeTxWithCustomFee(Transaction transaction,Coin fee) throws InsufficientMoneyException{
        ...
        walletManager.completeSend(sendRequest);
        // if the fee is different to the custom fee and the tx size is lower than 1kb (1000 bytes in coin2play core)
...
//                    }
    ...
    public Coin2PlayRate getRate(String coin) {
   ...
   public boolean isSyncWithNode() throws NoPeerConnectedException {
    ...
    @Override
    public List<Coin2PlayRate> listRates() {
        return rateDb.list();
    }
    ...
    public void saveRate(Coin2PlayRate coin2playRate){
        rateDb.insertOrUpdateIfExist(coin2playRate);
    }
