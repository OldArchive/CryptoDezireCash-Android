package cryptodezirecash.org.cryptodezirecashwallet.module;
...
import cryptodezirecash.org.cryptodezirecashwallet.utils.Configurations;

import static cryptodezirecash.org.cryptodezirecashwallet.module.CryptoDezireCashContext.CONTEXT;
import static cryptodezirecash.org.cryptodezirecashwallet.module.CryptoDezireCashContext.Files.BLOCKCHAIN_FILENAME;
import static cryptodezirecash.org.cryptodezirecashwallet.module.CryptoDezireCashContext.Files.CHECKPOINTS_FILENAME;
import static cryptodezirecash.org.cryptodezirecashwallet.module.CryptoDezireCashContext.Files.WALLET_FILENAME_PROTOBUF;
import static cryptodezirecash.org.cryptodezirecashwallet.module.CryptoDezireCashContext.Files.WALLET_KEY_BACKUP_PROTOBUF;
import static cryptodezirecash.org.cryptodezirecashwallet.module.CryptoDezireCashContext.NETWORK_PARAMETERS;
import static cryptodezirecash.org.cryptodezirecashwallet.module.CryptoDezireCashContext.PEER_DISCOVERY_TIMEOUT_MS;
import static cryptodezirecash.org.cryptodezirecashwallet.module.CryptoDezireCashContext.PEER_TIMEOUT_MS;
...
public class WalletConfImp extends Configurations implements WalletConfiguration {
    ...
    public int getTrustedNodePort() {
        return CryptoDezireCashContext.NETWORK_PARAMETERS.getPort();
    }

    @Override
    public String getMnemonicFilename() {
        return CryptoDezireCashContext.Files.BIP39_WORDLIST_FILENAME;
    }
    ...
    public NetworkParameters getNetworkParams() {
        return CryptoDezireCashContext.NETWORK_PARAMETERS;
    }
    ...
    public long getWalletAutosaveDelayMs() {
        return CryptoDezireCashContext.Files.WALLET_AUTOSAVE_DELAY_MS;
    }
    ...
    public int getMinMemoryNeeded() {
        return CryptoDezireCashContext.MEMORY_CLASS_LOWEND;
    }

    @Override
    public long getBackupMaxChars() {
        return CryptoDezireCashContext.BACKUP_MAX_CHARS;
    }

    @Override
    public boolean isTest() {
        return CryptoDezireCashContext.IS_TEST;
    }
