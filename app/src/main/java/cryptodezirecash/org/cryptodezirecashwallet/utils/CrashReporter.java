...
//	}
	...
	public static void appendApplicationInfo(final Appendable report, final CryptoDezireCashApplication application) throws IOException {
		...
		report.append("Test/Prod: " + (CryptoDezireCashContext.IS_TEST ? "test" : "prod") + "\n");
		...
		report.append("Network: " + CryptoDezireCashContext.NETWORK_PARAMETERS.getId() + "\n");
		final Wallet wallet = ((CryptoDezireCashModuleImp)application.getModule()).getWallet();
