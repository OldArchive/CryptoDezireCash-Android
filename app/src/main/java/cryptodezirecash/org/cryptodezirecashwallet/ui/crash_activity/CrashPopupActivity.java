package cryptodezirecash.org.cryptodezirecashwallet.ui.crash_activity;
...
public class CrashPopupActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private String authorities = "cryptodezirecash.org.cryptodezirecashwallet.myfileprovider";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        cryptodezirecashApplication.getAppConf().saveShowReportScreenOnStart(false);
    ...
    protected CharSequence subject(){
        return "Crash report"+" "+ cryptodezirecashApplication.getVersionName();
    }
    ...
    protected CharSequence collectWalletDump() throws IOException{
        return ((CryptoDezireCashModuleImp)cryptodezirecashApplication.getModule()).getWallet().toString(false,true,true,null);
    }
}
