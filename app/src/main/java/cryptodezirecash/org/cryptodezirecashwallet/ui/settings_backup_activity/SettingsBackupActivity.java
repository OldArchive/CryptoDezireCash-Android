package cryptodezirecash.org.cryptodezirecashwallet.ui.settings_backup_activity;
...
public class SettingsBackupActivity extends BaseActivity {
    ...
    private void backup() {
        ...
        try {
            ...
            boolean result = cryptodezirecashModule.backupWallet(backupFile, firstPassword);

            if (result){
                cryptodezirecashApplication.getAppConf().setHasBackup(true);
