package cryptodezirecash.org.cryptodezirecashwallet.ui.export_account;
...
import cryptodezirecash.org.cryptodezirecashwallet.utils.AndroidUtils;
...
/**
 * Created by akshaynexus on 8/29/17.
 */
...
public class ExportKeyActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initValues() throws WriterException {
        DeterministicKey deterministicKey = cryptodezirecashModule.getWatchingKey();
        xpubKey = deterministicKey.serializePubB58(CryptoDezireCashContext.NETWORK_PARAMETERS);
