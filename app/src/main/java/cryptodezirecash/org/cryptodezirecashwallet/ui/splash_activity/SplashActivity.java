package cryptodezirecash.org.cryptodezirecashwallet.ui.splash_activity;
...
public class SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Uri video;
        if(CryptoDezireCashApplication.getInstance().getAppConf().isSplashSoundEnabled())
    ...
    private void jump() {
        ...
        if (CryptoDezireCashApplication.getInstance().getAppConf().isAppInit()){
            Intent intent = new Intent(this, WalletActivity.class);
            startActivity(intent);
        }else {
