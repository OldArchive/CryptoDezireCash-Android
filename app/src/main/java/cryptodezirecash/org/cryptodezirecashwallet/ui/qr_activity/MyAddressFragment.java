...
import static cryptodezirecash.org.cryptodezirecashwallet.utils.AndroidUtils.copyToClipboard;
...
public class MyAddressFragment extends Fragment implements View.OnClickListener {
    ...
    private CryptoDezireCashModule module;
    ...
    public static MyAddressFragment newInstance(CryptoDezireCashModule cryptodezirecashModule) {
        MyAddressFragment f = new MyAddressFragment();
        f.setModule(cryptodezirecashModule);
        return f;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        module = CryptoDezireCashApplication.getInstance().getModule();
    ...
    public void onResume() {
        ...
        try {
            ...
            if (flag) {
                String cryptodezirecashUri = SendURI.convertToBitcoinURI(address,null,"Receive address",null);
                loadAddress(cryptodezirecashUri,address.toBase58());
            }
    ...
    public void setModule(CryptoDezireCashModule module) {
        this.module = module;
    }
