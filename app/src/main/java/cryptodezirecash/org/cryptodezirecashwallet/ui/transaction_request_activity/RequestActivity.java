package cryptodezirecash.org.cryptodezirecashwallet.ui.transaction_request_activity;
...
import cryptodezirecash.org.cryptodezirecashwallet.ui.transaction_send_activity.AmountInputFragment;
...
import static cryptodezirecash.org.cryptodezirecashwallet.ui.qr_activity.MyAddressFragment.convertDpToPx;
import static cryptodezirecash.org.cryptodezirecashwallet.utils.QrUtils.encodeAsBitmap;
...
public class RequestActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void showRequestQr() throws Exception {
        ...
        addressStr = cryptodezirecashModule.getFreshNewAddress().toBase58();

        NetworkParameters params = cryptodezirecashModule.getConf().getNetworkParams();

        String cryptodezirecashURI = SendURI.convertToBitcoinURI(
                params,
                addressStr,
                amount,
        ...
        qrDialog = QrDialog.newInstance(cryptodezirecashURI);
        qrDialog.setQrText(cryptodezirecashURI);
    ...
    public static class QrDialog extends DialogFragment {
        ...
        public static QrDialog newInstance(String cryptodezirecashURI) throws WriterException {
