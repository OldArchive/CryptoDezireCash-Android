package cryptodezirecash.org.cryptodezirecashwallet.ui.words_restore_activity;
...
import cryptodezirecash.org.cryptodezirecashwallet.ui.transaction_send_activity.MyFilterableAdapter;
import cryptodezirecash.org.cryptodezirecashwallet.ui.transaction_send_activity.MyTextWatcher;
...
import static cryptodezirecash.org.cryptodezirecashwallet.module.CryptoDezireCashContext.CryptoDezireCash_WALLET_APP_RELEASED_ON_PLAY_STORE_TIME;
...
public class RestoreWordsActivity extends BaseActivity {
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        //Words
        mnemonicWords = cryptodezirecashModule.getAvailableMnemonicWordsList();
                            ...
                            public void onRightBtnClicked(SimpleTwoButtonsDialog dialog) {
                                ...
                                executorService.submit(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        try {
                                            // loading here..
                                            cryptodezirecashModule.checkMnemonic(mnemonic);

                                            boolean isBip32 = check_bip32.isChecked();

                                            cryptodezirecashModule.restoreWallet(mnemonic, CryptoDezireCash_WALLET_APP_RELEASED_ON_PLAY_STORE_TIME,!isBip32);
                                        ...
                                        runOnUiThread(new Runnable() {
                                            ...
                                            public void run() {
                                                if (finalResult){
                                                    ...
                                                    if (cryptodezirecashApplication.getAppConf().getPincode() != null){
                                                        // Check if the app is starting
                                                        if(!cryptodezirecashApplication.getAppConf().isAppInit()){
                                                            cryptodezirecashApplication.getAppConf().setAppInit(true);
                                                        }
    ...
    public class ViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            if (position==0) {
                ...
                txt_bip32_message.setText(getString(R.string.restore_bip32_warning, CryptoDezireCashContext.ENABLE_BIP44_APP_VERSION));
