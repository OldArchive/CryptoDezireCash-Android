package cryptodezirecash.org.cryptodezirecashwallet.ui.import_watch_only;
...
import static cryptodezirecash.org.cryptodezirecashwallet.utils.CrashReporter.appendSavedBackgroundTraces;
...
public class SettingsWatchOnly extends BaseActivity {
    ...
    private void importXpub() {
        ...
        if (xpub.length()>0){
            try {
                cryptodezirecashModule.watchOnlyMode(
                        xpub,
                        isBip32 ? DeterministicKeyChain.KeyChainType.BIP32: DeterministicKeyChain.KeyChainType.BIP44_CDZC_ONLY
                );
