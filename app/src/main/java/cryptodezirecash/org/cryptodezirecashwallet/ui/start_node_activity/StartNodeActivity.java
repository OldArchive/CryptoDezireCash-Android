package cryptodezirecash.org.cryptodezirecashwallet.ui.start_node_activity;
...
import cryptodezirecash.org.cryptodezirecashwallet.utils.DialogBuilder;
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        findViewById(R.id.btn_default).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Check this..
                cryptodezirecashApplication.setTrustedServer(trustedNodes.get(3));
        ...
        btnSelectNode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean isStarted = cryptodezirecashApplication.getAppConf().getTrustedNode()!=null;
                cryptodezirecashApplication.setTrustedServer(selectedNode);
        ...
        PivtrumPeerData pivtrumPeer = cryptodezirecashApplication.getAppConf().getTrustedNode();
