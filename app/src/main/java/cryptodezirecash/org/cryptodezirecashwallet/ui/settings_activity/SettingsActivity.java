package cryptodezirecash.org.cryptodezirecashwallet.ui.settings_activity;
...
import cryptodezirecash.org.cryptodezirecashwallet.ui.export_account.ExportKeyActivity;
import cryptodezirecash.org.cryptodezirecashwallet.ui.import_watch_only.SettingsWatchOnly;
...
import cryptodezirecash.org.cryptodezirecashwallet.ui.settings_network_activity.SettingsNetworkActivity;
import cryptodezirecash.org.cryptodezirecashwallet.ui.settings_pincode_activity.SettingsPincodeActivity;
import cryptodezirecash.org.cryptodezirecashwallet.ui.settings_rates.SettingsRatesActivity;
import cryptodezirecash.org.cryptodezirecashwallet.ui.start_node_activity.StartNodeActivity;
...
import cryptodezirecash.org.cryptodezirecashwallet.utils.IntentsUtils;
import cryptodezirecash.org.cryptodezirecashwallet.utils.NavigationUtils;
import cryptodezirecash.org.cryptodezirecashwallet.utils.ReportIssueDialogBuilder;
...
import static cryptodezirecash.org.cryptodezirecashwallet.ui.tutorial_activity.TutorialActivity.INTENT_EXTRA_INFO_TUTORIAL;
...
public class SettingsActivity extends BaseDrawerActivity implements View.OnClickListener {
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        String text = "Made by<br> <font color=#55476c>akshaynexus</font> <br>(c) CDZC Community (c) PIVX Devs";
        ...
        text_rates.setText(cryptodezirecashApplication.getAppConf().getSelectedRateCoin());
        ...
        videoSwitch.setChecked(cryptodezirecashApplication.getAppConf().isSplashSoundEnabled());
        videoSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean checked) {
                cryptodezirecashApplication.getAppConf().setSplashSound(checked);
            }
        });
    }
    ...
    private void updateNetworkStatus() {
        ...
        txt_network_info.setText(
                Html.fromHtml(
                        "Network<br><font color=#55476c>"+cryptodezirecashModule.getConf().getNetworkParams().getId()+
                                "</font><br>" +
                                "Height<br><font color=#55476c>"+cryptodezirecashModule.getChainHeight()+"</font><br>" +
                                "Protocol Version<br><font color=#55476c>"+
                                cryptodezirecashModule.getProtocolVersion()+"</font>"
        ...
        SimpleTwoButtonsDialog dialog = DialogsUtil.buildSimpleTwoBtnsDialog(
                ...
                new SimpleTwoButtonsDialog.SimpleTwoBtnsDialogListener() {
                    ...
                    public void onRightBtnClicked(SimpleTwoButtonsDialog dialog) {
                        cryptodezirecashApplication.stopBlockchain();
    ...
    private void launchReportDialog() {
        ReportIssueDialogBuilder dialog = new ReportIssueDialogBuilder(
                this,
                "cryptodezirecash.org.cryptodezirecashwallet.myfileprovider",
                ...
                R.string.report_issue_dialog_message_issue)
        {
            ...
            protected CharSequence subject() {
                return CryptoDezireCashContext.REPORT_SUBJECT_ISSUE+" "+cryptodezirecashApplication.getVersionName();
            }
            ...
            protected CharSequence collectApplicationInfo() throws IOException {
                ...
                CrashReporter.appendApplicationInfo(applicationInfo, cryptodezirecashApplication);
            ...
            protected CharSequence collectWalletDump() throws IOException {
                return ((CryptoDezireCashModuleImp)cryptodezirecashModule).getWallet().toString(false,true,true,null);
            }
        };
        dialog.show();
    }
