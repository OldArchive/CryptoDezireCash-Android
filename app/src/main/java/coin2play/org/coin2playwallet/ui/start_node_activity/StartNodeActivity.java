package coin2play.org.coin2playwallet.ui.start_node_activity;
...
import coin2play.org.coin2playwallet.ui.pincode_activity.PincodeActivity;
import coin2play.org.coin2playwallet.ui.wallet_activity.WalletActivity;
import coin2play.org.coin2playwallet.utils.DialogBuilder;
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        findViewById(R.id.btn_default).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Check this..
                coin2playApplication.setTrustedServer(trustedNodes.get(3));
        ...
        btnSelectNode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean isStarted = coin2playApplication.getAppConf().getTrustedNode()!=null;
                coin2playApplication.setTrustedServer(selectedNode);
        ...
        PivtrumPeerData pivtrumPeer = coin2playApplication.getAppConf().getTrustedNode();
