...
import static coin2play.org.coin2playwallet.utils.AndroidUtils.copyToClipboard;
...
public class MyAddressFragment extends Fragment implements View.OnClickListener {
    ...
    private Coin2PlayModule module;
    ...
    public static MyAddressFragment newInstance(Coin2PlayModule coin2playModule) {
        MyAddressFragment f = new MyAddressFragment();
        f.setModule(coin2playModule);
        return f;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        module = Coin2PlayApplication.getInstance().getModule();
    ...
    public void onResume() {
        ...
        try {
            ...
            if (flag) {
                String coin2playUri = SendURI.convertToBitcoinURI(address,null,"Receive address",null);
                loadAddress(coin2playUri,address.toBase58());
            }
    ...
    public void setModule(Coin2PlayModule module) {
        this.module = module;
    }
