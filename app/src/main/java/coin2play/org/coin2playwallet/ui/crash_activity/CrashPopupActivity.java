package coin2play.org.coin2playwallet.ui.crash_activity;
...
public class CrashPopupActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private String authorities = "coin2play.org.coin2playwallet.myfileprovider";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        coin2playApplication.getAppConf().saveShowReportScreenOnStart(false);
    ...
    protected CharSequence subject(){
        return "Crash report"+" "+ coin2playApplication.getVersionName();
    }
    ...
    protected CharSequence collectWalletDump() throws IOException{
        return ((Coin2PlayModuleImp)coin2playApplication.getModule()).getWallet().toString(false,true,true,null);
    }
}
