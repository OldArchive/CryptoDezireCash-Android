package coin2play.org.coin2playwallet.ui.settings_backup_activity;
...
public class SettingsBackupActivity extends BaseActivity {
    ...
    private void backup() {
        ...
        try {
            ...
            boolean result = coin2playModule.backupWallet(backupFile, firstPassword);

            if (result){
                coin2playApplication.getAppConf().setHasBackup(true);
