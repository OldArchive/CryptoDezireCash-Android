package coin2play.org.coin2playwallet.ui.transaction_request_activity;
...
import coin2play.org.coin2playwallet.ui.transaction_send_activity.AmountInputFragment;
import coin2play.org.coin2playwallet.utils.DialogsUtil;
import coin2play.org.coin2playwallet.utils.NavigationUtils;

import static android.graphics.Color.WHITE;
import static coin2play.org.coin2playwallet.ui.qr_activity.MyAddressFragment.convertDpToPx;
import static coin2play.org.coin2playwallet.utils.QrUtils.encodeAsBitmap;
...
public class RequestActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void showRequestQr() throws Exception {
        ...
        addressStr = coin2playModule.getFreshNewAddress().toBase58();

        NetworkParameters params = coin2playModule.getConf().getNetworkParams();

        String coin2playURI = SendURI.convertToBitcoinURI(
                params,
                addressStr,
                amount,
        ...
        qrDialog = QrDialog.newInstance(coin2playURI);
        qrDialog.setQrText(coin2playURI);
    ...
    public static class QrDialog extends DialogFragment {
        ...
        public static QrDialog newInstance(String coin2playURI) throws WriterException {
