package coin2play.org.coin2playwallet.ui.export_account;
...
import coin2play.org.coin2playwallet.utils.AndroidUtils;
...
public class ExportKeyActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initValues() throws WriterException {
        DeterministicKey deterministicKey = coin2playModule.getWatchingKey();
        xpubKey = deterministicKey.serializePubB58(Coin2PlayContext.NETWORK_PARAMETERS);
