package coin2play.org.coin2playwallet.ui.splash_activity;
...
public class SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Uri video;
        if(Coin2PlayApplication.getInstance().getAppConf().isSplashSoundEnabled())
    ...
    private void jump() {
        ...
        if (Coin2PlayApplication.getInstance().getAppConf().isAppInit()){
            Intent intent = new Intent(this, WalletActivity.class);
            startActivity(intent);
        }else {
