package coin2play.org.coin2playwallet.ui.settings_activity;
...
import coin2play.org.coin2playwallet.BuildConfig;
...
import coin2play.org.coin2playwallet.ui.export_account.ExportKeyActivity;
import coin2play.org.coin2playwallet.ui.import_watch_only.SettingsWatchOnly;
import coin2play.org.coin2playwallet.ui.restore_activity.RestoreActivity;
import coin2play.org.coin2playwallet.ui.settings_backup_activity.SettingsBackupActivity;
import coin2play.org.coin2playwallet.ui.settings_network_activity.SettingsNetworkActivity;
import coin2play.org.coin2playwallet.ui.settings_pincode_activity.SettingsPincodeActivity;
import coin2play.org.coin2playwallet.ui.settings_rates.SettingsRatesActivity;
import coin2play.org.coin2playwallet.ui.start_node_activity.StartNodeActivity;
import coin2play.org.coin2playwallet.ui.tutorial_activity.TutorialActivity;
import coin2play.org.coin2playwallet.utils.CrashReporter;
import coin2play.org.coin2playwallet.utils.DialogsUtil;
import coin2play.org.coin2playwallet.utils.IntentsUtils;
import coin2play.org.coin2playwallet.utils.NavigationUtils;
import coin2play.org.coin2playwallet.utils.ReportIssueDialogBuilder;
...
import static coin2play.org.coin2playwallet.ui.tutorial_activity.TutorialActivity.INTENT_EXTRA_INFO_TUTORIAL;
...
public class SettingsActivity extends BaseDrawerActivity implements View.OnClickListener {
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        String text = "Made by<br> <font color=#55476c>akshaynexus</font> <br>(c) C2P Community (c) PIVX Devs";
        ...
        text_rates.setText(coin2playApplication.getAppConf().getSelectedRateCoin());
        ...
        videoSwitch.setChecked(coin2playApplication.getAppConf().isSplashSoundEnabled());
        videoSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean checked) {
                coin2playApplication.getAppConf().setSplashSound(checked);
            }
        });
    }
    ...
    private void updateNetworkStatus() {
        ...
        txt_network_info.setText(
                Html.fromHtml(
                        "Network<br><font color=#55476c>"+coin2playModule.getConf().getNetworkParams().getId()+
                                "</font><br>" +
                                "Height<br><font color=#55476c>"+coin2playModule.getChainHeight()+"</font><br>" +
                                "Protocol Version<br><font color=#55476c>"+
                                coin2playModule.getProtocolVersion()+"</font>"
        ...
        SimpleTwoButtonsDialog dialog = DialogsUtil.buildSimpleTwoBtnsDialog(
                ...
                new SimpleTwoButtonsDialog.SimpleTwoBtnsDialogListener() {
                    ...
                    public void onRightBtnClicked(SimpleTwoButtonsDialog dialog) {
                        coin2playApplication.stopBlockchain();
    ...
    private void launchReportDialog() {
        ReportIssueDialogBuilder dialog = new ReportIssueDialogBuilder(
                this,
                "coin2play.org.coin2playwallet.myfileprovider",
                ...
                R.string.report_issue_dialog_message_issue)
        {
            ...
            protected CharSequence subject() {
                return Coin2PlayContext.REPORT_SUBJECT_ISSUE+" "+coin2playApplication.getVersionName();
            }
            ...
            protected CharSequence collectApplicationInfo() throws IOException {
                ...
                CrashReporter.appendApplicationInfo(applicationInfo, coin2playApplication);
            ...
            protected CharSequence collectWalletDump() throws IOException {
                return ((Coin2PlayModuleImp)coin2playModule).getWallet().toString(false,true,true,null);
            }
        };
        dialog.show();
    }
