package coin2play.org.coin2playwallet.ui.words_restore_activity;
...
import coin2play.org.coin2playwallet.ui.transaction_send_activity.MyFilterableAdapter;
import coin2play.org.coin2playwallet.ui.transaction_send_activity.MyTextWatcher;
...
import static coin2play.org.coin2playwallet.module.Coin2PlayContext.Coin2Play_WALLET_APP_RELEASED_ON_PLAY_STORE_TIME;
...
public class RestoreWordsActivity extends BaseActivity {
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        //Words
        mnemonicWords = coin2playModule.getAvailableMnemonicWordsList();
                            ...
                            public void onRightBtnClicked(SimpleTwoButtonsDialog dialog) {
                                ...
                                executorService.submit(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        try {
                                            // loading here..
                                            coin2playModule.checkMnemonic(mnemonic);

                                            boolean isBip32 = check_bip32.isChecked();

                                            coin2playModule.restoreWallet(mnemonic, Coin2Play_WALLET_APP_RELEASED_ON_PLAY_STORE_TIME,!isBip32);
                                        ...
                                        runOnUiThread(new Runnable() {
                                            ...
                                            public void run() {
                                                if (finalResult){
                                                    ...
                                                    if (coin2playApplication.getAppConf().getPincode() != null){
                                                        // Check if the app is starting
                                                        if(!coin2playApplication.getAppConf().isAppInit()){
                                                            coin2playApplication.getAppConf().setAppInit(true);
                                                        }
    ...
    public class ViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            if (position==0) {
                ...
                txt_bip32_message.setText(getString(R.string.restore_bip32_warning, Coin2PlayContext.ENABLE_BIP44_APP_VERSION));
