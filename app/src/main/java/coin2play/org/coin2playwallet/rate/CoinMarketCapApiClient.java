...
public class CoinMarketCapApiClient {
    ...
    public Coin2PlayMarket getCoin2PlayPxrice() throws RequestCoin2PlayRateException{
        try {
            ...
            e.printStackTrace();
            throw new RequestCoin2PlayRateException(e);
        } catch (IOException e) {
            e.printStackTrace();
            throw new RequestCoin2PlayRateException(e);
    ...
    public static class BitPayApi {
         ...
         * @return
         * @throws RequestCoin2PlayRateException
         */
        public <T> List<T> getRates(RatesConvertor<T> ratesConvertor) throws RequestCoin2PlayRateException{
            try {
                HttpResponse httpResponse = get(URL);
                // receive response as inputStream
                InputStream inputStream = httpResponse.getEntity().getContent();
