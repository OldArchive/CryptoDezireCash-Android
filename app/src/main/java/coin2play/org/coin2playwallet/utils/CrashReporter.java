...
//	}
	...
	public static void appendApplicationInfo(final Appendable report, final Coin2PlayApplication application) throws IOException {
		...
		final Wallet wallet = ((Coin2PlayModuleImp)application.getModule()).getWallet();
